...
def generate_winding_gcode(
    ...
    segments_per_turn = max(12, int(segments_per_turn))
...
class App:
    ...
    def _generate_gcode(self):
        ...
        feed = max(100.0, safe_float(self.feed_entry.get(), 1200))
        start_angle = safe_float(self.start_angle_entry.get(), 0.0)
        clockwise = bool(self.clockwise_var.get())
        segments_per_turn = max(12, int(safe_float(self.segm_entry.get(), 120)))
    ...
    def create_widgets(self):
        ...
        self.turns_entry.grid(row=1, column=1, padx=4)
        ...
        self.feed_entry.grid(row=1, column=3, padx=4)
        ...
        self.segm_entry.grid(row=2, column=1, padx=4)
